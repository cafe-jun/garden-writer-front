...
import st from './writer-recruitment.module.scss';
  ...
  return (
    <>
      ...
      <OneLineInput
        ...
        tooltipText="소설을 함께 작성하실 작가를 모집하는 게시물의 제목입니다"
      />
      <MultilineInput
        ...
        tooltipText="함께 소설을 작성하실 작가를 모집하는 게시글의 내용입니다."
...
평소에 판타지 소설 즐겨보시는 아이디어 뱅크 분을 찾고 있습니다. 평일 저녁 8시 이후로 시간 되시는 분 선호하고 잠수는 강퇴합니다. 궁금하신 점은 오픈 채팅으로 연락해 주세요.`}
      ...
      <OneLineInput
        ...
        tooltipText="“작가모집 게시글을 보고 작가 분들이 해당 링크로 연락을 할 수 있습니다. 카카오톡 오픈채팅방 (1:1 채팅방) 생성 후 링크를 기입해 주세요.”"
      />
    </>
  );
}
